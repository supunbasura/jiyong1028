...
//        setBounds(100, 100, 1600, 900);
    ...
    private void checkAnswer(String selectedSentence) {
        if (selectedSentence.equals(correctSentences[currentQuestionIndex])) {
            ...
            sentence1.setBackground(selectedSentence.equals(sentence1.getText()) ? Color.GREEN : null);
            sentence2.setBackground(selectedSentence.equals(sentence2.getText()) ? Color.GREEN : null);
        } else {
            explain.setText("Incorrect! " + explanations[currentQuestionIndex]);
            sentence1.setBackground(selectedSentence.equals(sentence1.getText()) ? Color.RED : null);
            sentence2.setBackground(selectedSentence.equals(sentence2.getText()) ? Color.RED : null);
        }
        totalQuestions++;
    }
}
